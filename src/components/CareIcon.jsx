...
function Shade({ leaves = 1 }) {
  return (
    <svg {...iconProps}>
      <path
        d="M10 35c9-22 22-24 29-23-1 8-6 20-27 25"
        fill="currentColor"
        opacity="0.12"
      />
...
function Water({ drops = 1 }) {
  return (
    <svg {...iconProps}>
      <path
        d="M24 7s-10 12-10 21a10 10 0 0 0 20 0C34 19 24 7 24 7z"
        fill="currentColor"
        opacity="0.12"
      />
      <path d="M24 7s-10 12-10 21a10 10 0 0 0 20 0C34 19 24 7 24 7z" />
      {drops > 1 && (
        <path d="M10 16s-4 5-4 9a4 4 0 0 0 8 0c0-4-4-9-4-9zM38 16s-4 5-4 9a4 4 0 0 0 8 0c0-4-4-9-4-9z" />
      )}
...
function Paw({ alert = false }) {
  return (
    <svg {...iconProps}>
      ...
      <path
        d="M17 31c0-5 3-9 7-9s7 4 7 9c0 4-3 6-7 6s-7-2-7-6z"
        fill="currentColor"
        opacity="0.12"
      />
...
function California() {
  return (
    <svg {...iconProps}>
      <path
        d="M16 7l11 2 3 9 6 6-4 17H18l-3-9 3-9-4-7 2-9z"
        fill="currentColor"
        opacity="0.12"
      />
...
function Sprout() {
  return (
    <svg {...iconProps}>
      <path d="M24 40V19" />
      <path
        d="M24 22c-8 0-13-5-14-13 8 0 13 5 14 13z"
        fill="currentColor"
        opacity="0.12"
      />
      <path d="M24 22c-8 0-13-5-14-13 8 0 13 5 14 13z" />
      <path
        d="M24 27c8 0 13-5 14-13-8 0-13 5-14 13z"
        fill="currentColor"
        opacity="0.12"
      />
